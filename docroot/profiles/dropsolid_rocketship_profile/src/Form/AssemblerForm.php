...
class AssemblerForm extends FormBase {
   ...
   *   The module extension list.
   */
  public function __construct($root, InfoParserInterface $info_parser, TranslationInterface $translator, ModuleHandlerInterface $module_handler, ThemeHandlerInterface $themeHandler, ModuleExtensionList $module_extension_list = NULL) {
    $this->root = $root;
