...
(function ($, Drupal, window, document) {
  ...
  self.focusFields = function (input, textarea, select) {
    ...
    if (input.length) {
      // iterate all inputs
      once('input', input).forEach(function(inputElement) {
    ...
    if (textarea.length) {
      once('textarea', textarea).forEach(function(textareaElement) {
    ...
    if (select.length) {
      once('select', select).forEach(function(selectElement) {
  ...
  self.customSelect = function (select) {
    once('select-wrap', select).forEach(function (selectElement) {
  ...
  self.textareaScroll = function (textarea) {
    ...
    once('textarea-scroll', textarea).forEach(function(textareaElement) {
